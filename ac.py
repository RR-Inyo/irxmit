...
# Test of encoding IR remote control signal for Panasonic air conditioners
# (c) 2020 @RR_Inyo
...
class ACpana():
    ...
    def __command(self, frame_2):
        ...
        if DEBUG:
            print(f'1st frame: {ACpana.FRAME_1}')
            print(f'2nd frame: {frame_2}')

        # Connecting the two frames
        frame = ACpana.FRAME_1 + '++' + frame_2
...
def main():
    ...
    # Turn on the air conditioner in cooling mode at 22 degree Celcius
    ac.on_cooling(22)
